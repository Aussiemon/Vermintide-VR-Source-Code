-- chunkname: @script/lua/views/result_view_demo.lua

require("script/lua/simple_gui/simple_gui")

local templates = require("script/lua/simple_gui/gui_templates")
local definitions = require("script/lua/views/result_view_demo_definitions")

class("ResultViewDemo")

ResultViewDemo.init = function (self, world, input, parent)
	self._world = world
...
ResultViewDemo._initialize_elements = function (self, skip_elements)
...
ResultViewDemo.cb_start_rotation = function (self)
...
ResultViewDemo.cb_leaderboard_fetched = function (self, leaderboard_type, results)
...
ResultViewDemo._package_leaderboard_data = function (self, leaderboard_type, results)
...
ResultViewDemo.add_element = function (self, position, name, kills, headshots, seconds_played, score)
...
ResultViewDemo.enable = function (self, enable, success)
...
ResultViewDemo._add_animation = function (self, element, field, start_value, end_value, time, func, callback)
...
ResultViewDemo.enabled = function (self)
	return self._enabled
end

ResultViewDemo._create_gui = function (self)
...
ResultViewDemo._update_level_elements = function (self)
	...
	if is_multiplayer then
		...
		self._scoreboard_elements.level_1.material_name = current_level_material
		self._scoreboard_elements.level_1.level_name = current_level_name

		if self._selectable_elements.level_1 then
			self._selectable_elements.level_1.material_name = current_level_material
			self._selectable_elements.level_1.level_name = current_level_name
		end
		...
		for idx, level_data in ipairs(level_images) do
			self._scoreboard_elements["level_" .. idx + 1].material_name = level_data.material_name
			self._scoreboard_elements["level_" .. idx + 1].level_name = level_data.level_name

			if self._selectable_elements["level_" .. idx + 1] then
				self._selectable_elements["level_" .. idx + 1].material_name = level_data.material_name
				self._selectable_elements["level_" .. idx + 1].level_name = level_data.level_name
			end
		end
	else
		local level_images = {
...
ResultViewDemo.reinitialize_scoreboard = function (self, leaderboard_type)
...
ResultViewDemo.update = function (self, dt, t)
	if DO_RELOAD then
		self._scoreboard_index = 1
		self._scoreboard_scroll_offset_speed = 350
		self._scoreboard_scroll_offset = 0
	...
	Profiler.stop("ResultViewDemo")
end

ResultViewDemo._update_scores = function (self, dt, t)
...
ResultViewDemo._player_name = function (self, peer_id)
...
ResultViewDemo._update_scroller = function (self, dt, t)
...
ResultViewDemo._update_input = function (self, dt, t)
...
ResultViewDemo._update_selectable_animations = function (self, dt, t)
...
ResultViewDemo._update_animations = function (self, dt, t)
...
ResultViewDemo._update_position_on_gui = function (self, dt, t)
	local pos, dir
...
ResultViewDemo._update_gui_position = function (self, dt, t)
...
ResultViewDemo._update_ui = function (self, dt, t)
...
ResultViewDemo.destroy = function (self)
