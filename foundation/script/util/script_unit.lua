-- chunkname: @foundation/script/util/script_unit.lua

ScriptUnit = ScriptUnit or {}

local Unit = stingray.Unit

local function fassert(condition, str, ...)
...
local function local_remove_extension(unit, system_name)
	local unit_extensions = assert(Entities[unit])
...
ScriptUnit.set_extension = function (unit, extension_name, extension)
	set_extension_script(unit, extension_name, extension)
end
